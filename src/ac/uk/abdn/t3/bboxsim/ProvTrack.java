...
public class ProvTrack {
	static String host="http://t3.abdn.ac.uk:8080/";
	...
	static String bbox_ns="bbox:"; static String bbox_prefix="http://t3.abdn.ac.uk/t3v2/1/device/"+Memory.deviceId+"/";
   ...
   public void getTrack(){
	...
	Log.e("Sending prov:",body);
			...
			try {
			    HttpPost request = new HttpPost(host+"t3v2/1/device/upload/"+Memory.deviceId+"/prov");
