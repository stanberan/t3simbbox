...
//		MainActivity.z.setText("Z: \t"+z+"\t"+az_min+"\t"+az_max+"\t"+z_total+"\t"+(double)(z_total/acc_size)+"\t"+range);
	...
	public static String getJsonData(){
		...
		Location l= MainActivity.previousLocation;
		Location p=MainActivity.secondLocation;
		if((l!=null && p==null)||(l!=null && p!=null && l.getTime()!=p.getTime()) ){
		 ...
		 Date sent=new Date(System.currentTimeMillis());
